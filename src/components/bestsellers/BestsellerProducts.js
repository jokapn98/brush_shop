...
const BestsellerProducts = ({ brushes }) => {
  return (
    <div className="col-12 best-border">
      <div className="best-products col-12 row">
        ...
        <div className="best-viewMore col-12 d-flex justify-content-center">
          <Link
            to="/shop/page/:pageNum"
            className="col-lg-2 col-md-3 col-4 button-b col-5 d-flex justify-content-center text-decoration-none"
          >
            View more
          </Link>
        </div>
